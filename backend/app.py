...
def tarea_fondo_ia(datos):
    ...
    try:
        ...
        prompt_espiritu = (
            ...
            f"Actúa como un Analista de Sistemas experto y FILTRO ÉTICO DE SEGURIDAD.\n\n"
            f"REGLA DE ORO ABSOLUTA:\n"
            f"Analiza la consulta del cliente: '''{texto_cliente}'''\n"
            f"Si el cliente menciona: evadir impuestos, hackear, engañar, modificar documentos legales, "
            f"fraude, o cualquier actividad ilegal, DEBES DETENERTE de inmediato.\n\n"
            f"TU RESPUESTA EN CASO DE ILEGALIDAD:\n"
            f"Responde SOLO Y ÚNICAMENTE con esta frase: 'Lo sentimos, IAsesoria no realiza proyectos que no cumplan con nuestros estándares éticos y legales.' y NO ESCRIBAS NADA MÁS. No generes puntos, no generes resumen, no generes estructura. Silencio total después de la frase.\n\n"
            f"SOLO SI LA SOLICITUD ES LEGAL, genera lo siguiente:\n"
